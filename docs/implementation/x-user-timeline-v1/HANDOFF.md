...
W09 is a real human gate: only the user can run the authorized local live smoke and interruption/resume procedure. Once its redacted evidence passes, continue automatically through W10, PR readiness/merge, and exact-main Post-Merge.
